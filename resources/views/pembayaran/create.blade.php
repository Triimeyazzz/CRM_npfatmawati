...
<div class="container mx-auto py-10">
    ...
    <form action="{{ route('pembayaran.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-8 max-w-lg mx-auto space-y-6">
        ...
        <div class="mb-6">
            ...
            <select name="siswa_id" id="siswa_id" class="select2 mt-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-400 transition duration-150 ease-in-out" required>
