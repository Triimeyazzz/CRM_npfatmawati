<nav class="bg-gradient-to-r from-purple-950 to-blue-800 p-4 sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="lg:hidden">
            <button id="navbar-toggle" class="text-white focus:outline-none" onclick="toggleNavbar()">
        ...
        <div id="navbar" class="lg:flex lg:flex-grow items-center hidden">
            <div class="lg:flex lg:items-center lg:justify-end lg:flex-grow">
                <div class="flex flex-col lg:flex-row lg:space-x-8 lg:items-center lg:space-y-4 space-y-4">
                    <a href="{{ route('home') }}"
                        class="text-yellow-400 hover:text-yellow-200 {{ request()->routeIs('home') ? 'border-b-2 border-purple-500' : '' }}">Home</a>
                    <a href="{{ route('home.about') }}" class="text-yellow-400 hover:text-yellow-200 {{ request()->routeIs('home.about') ? 'border-b-2 border-purple-500' : '' }}">About Us</a>
                    ...
                    @if (Auth::check())
                        ...
                        <a href="{{ route('siswa.attendance') }}" class="text-yellow-400 hover:text-yellow-200">Absensi</a>
                    @else
